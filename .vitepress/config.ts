 ...
 * @LastEditors: dyb-dev
 * @LastEditTime: 2025-10-30 23:30:55
...
import { sidebar as referenceSidebar } from "../src/views/reference"
...
/** CONST: 左侧边栏菜单配置 */
const sidebar: DefaultTheme.Sidebar = { ...referenceSidebar.config }
...
const configFn: UserConfigFn<DefaultTheme.Config> = ({ mode }) => {
    ...
    return defineConfig({
        ...
        themeConfig: {
            ...
            // 页面编辑链接配置
            editLink: {
                pattern: "https://github.com/dyb-dev/lib-docs-template/tree/main/src/views/:path",
                text: "为此页面提供修改建议"
            },
